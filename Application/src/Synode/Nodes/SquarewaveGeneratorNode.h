...
class SquarewaveGeneratorNode : public ImFlow::BaseNode
{

public:
    SquarewaveGeneratorNode()
    {

        m_Generator = std::make_unique<ModIO::Generators::SquarewaveGenerator>();

        m_Generator->mFrequency = m_Frequency;
        m_Generator->mAmplitude = m_Volume * 0.01f;

        setTitle("Square Wave Generator");
...
private:
    ModIO::TD::UniqueSquarewaveGenerator m_Generator;
