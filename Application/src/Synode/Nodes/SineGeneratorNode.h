...
class SineGeneratorNode : public ImFlow::BaseNode
{
...
public:
    SineGeneratorNode()
    {
        ...
        m_Generator = std::make_unique<ModIO::Generators::SinewaveGenerator>();
...
private:
    ModIO::TD::UniqueSinewaveGenerator m_Generator;
